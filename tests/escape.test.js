IR = {}; // eslint-disable-line no-undef
...
describe('escape', () => {
    it('test escape', () => {  
        ...
        expect(jsExtEscape('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789@*_+-./')).toBe(escape('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789@*_+-./'));  
    });
}); 